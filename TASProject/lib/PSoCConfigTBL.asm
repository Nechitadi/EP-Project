...
export LoadConfigTBL_tasproject_Bank1
export LoadConfigTBL_tasproject_Bank0
export LoadConfigTBL_tasproject_Ordered
AREA lit(rom, rel)
LoadConfigTBL_tasproject_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_tasproject_Bank1:
;  Instance name LCD, User Module LCD
...
LoadConfigTBL_tasproject_Ordered:
;  Ordered Global Register values
	...
	mov	reg[08h], 80h		; Port_2_Data register (PRT2DR)
	M8C_SetBank1
