...
export LoadConfig_tasproject
export _LoadConfig_tasproject
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_2_Data_SHADE], 80h
	mov		[Port_2_DriveMode_0_SHADE], ffh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_tasproject
	lcall	LoadConfigTBL_tasproject_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration tasproject
;
;    Load configuration registers for tasproject.
...
;               CUR_PP
;
_LoadConfig_tasproject:
 LoadConfig_tasproject:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_tasproject_Bank0
    mov     X, <LoadConfigTBL_tasproject_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_tasproject_Bank1
    mov     X, <LoadConfigTBL_tasproject_Bank1
